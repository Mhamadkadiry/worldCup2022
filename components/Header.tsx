        ...
        <div className="max-w-7xl mx-auto">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                    ...
                    <a href="#" className="w-full flex items-center justify-center px-8 py-2 border border-transparent text-base font-medium rounded-md text-white bg-[#9a074f] hover:bg-[#470f2a] md:py-4 md:text-lg md:px-10"> Fixtures </a>
                    </div>
                    <div className="mt-3 sm:mt-0 sm:ml-3">
                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-[#9a074f] bg-[#fddfed] hover:text-white hover:bg-[#963162] md:py-4 md:text-lg md:px-10">Teams</a>
                    </div>
                </div>
                </div>
            </main>
